...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Delate = new javax.swing.JMenuItem();
        ...
        Delate.setText("Eliminar");

        ToDopopupMenu.add(Delate);
        ...
        ToDoLs.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                if (!e.getValueIsAdjusting()) {
                    ...
                    Note aux = nodone.findNote(selectedTitle);

                    // Actualizar el contenido de jLabel1 con la información correspondiente
                    if (aux != null) {
                        String info = aux.getinfo();
                        jLabel1.setText(info);
                    } else {
                        jLabel1.setText(""); // Si no se encontró información, establecer el texto de jLabel1 en blanco
                    }
                }
            }
        });
        ...
        Note aux = nodone.findNote(" ");
        String Tinfo= " ";
        if(aux!=null){
            Tinfo=aux.getinfo();
        }
        jLabel1.setText(Tinfo);
        ...
        jButton1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedTitle != null) { // Verificar si hay algo seleccionado
                    // Realizar la acción de borrar la tarea
                    nodone.deleteByTitle(selectedTitle);
        ...
        jButton2.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Obtener el título de la tarea seleccionada en la lista "To Do"
                String selectedTitle = ToDoLs.getSelectedValue();

                if (selectedTitle != null) { // Verificar si hay algo seleccionado
                    // Mover la tarea seleccionada de "To Do" a "Done"
                    Note doneNote = nodone.DoneNote(selectedTitle);

                    if (doneNote != null) {
                        // Si se movió con éxito, agrega la tarea a la lista "Done"
                        done.insert(doneNote);
                    }
        ...
        TxInfoPnLayout.setHorizontalGroup(
            ...
            .addGroup(TxInfoPnLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(TxInfoPnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
private void updateLists() {
    ...
    String[] toDoItems = nodone.titles();
    ...
    void addTx(String title, String info) {
        ...
        nodone.insert(temp);
        model.addElement(temp.gettitle());
    }
    /**
    ...
    */
    ...
    private javax.swing.JMenuItem Delate;
